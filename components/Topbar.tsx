...
// 👇 use dynamic import to avoid SSR/interop issues
const BrandSwitcher = dynamic(() => import('./BrandSwitcher'), { ssr: false });
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div ref={ref} className="relative">
            ...
            {open && (
              <div role="menu" className="absolute right-0 mt-2 w-48 overflow-hidden rounded-xl border bg-white shadow-lg">
                ...
                <Link href="/integrations" className="block px-4 py-2 text-sm hover:bg-neutral-50" role="menuitem">
                  Integrations
                </Link>
